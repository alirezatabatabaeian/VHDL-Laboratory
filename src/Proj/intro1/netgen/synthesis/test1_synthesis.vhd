...
-- \   \   \/     Version: P.20131013
--  \   \         Application: netgen
--  /   /         Filename: test1_synthesis.vhd
-- /___/   /\     Timestamp: Mon Nov 09 03:21:09 2020
-- \   \  /  \ 
--  \___\/\___\
--             
-- Command	: -intstyle ise -ar Structure -tm test1 -w -dir netgen/synthesis -ofmt vhdl -sim test1.ngc test1_synthesis.vhd 
-- Device	: xc3s400-5-pq208
-- Input file	: test1.ngc
-- Output file	: E:\Proj\intro1\netgen\synthesis\test1_synthesis.vhd
-- # of Entities	: 1
-- Design Name	: test1
...
architecture Structure of test1 is
  ...
  signal clk_BUFGP_166 : STD_LOGIC; 
  signal count_or0000 : STD_LOGIC; 
  signal number_not0001 : STD_LOGIC; 
  signal number_or0000_237 : STD_LOGIC; 
  signal out1_0_259 : STD_LOGIC; 
  signal out1_1_260 : STD_LOGIC; 
  signal out1_2_261 : STD_LOGIC; 
  signal out1_3_262 : STD_LOGIC; 
  signal pause_IBUF_264 : STD_LOGIC; 
  signal pause_inv : STD_LOGIC; 
  signal reset_IBUF_267 : STD_LOGIC; 
  ...
  signal number_or00001_wg_cy : STD_LOGIC_VECTOR ( 7 downto 0 ); 
  signal number_or00001_wg_lut : STD_LOGIC_VECTOR ( 8 downto 0 ); 
begin
  XST_GND : GND
    port map (
      G => N0
  ...
  number_or00001_wg_cy_0_Q : MUXCY
    port map (
      CI => N1,
      DI => N0,
      S => number_or00001_wg_lut(0),
      O => number_or00001_wg_cy(0)
    );
  number_or00001_wg_lut_1_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(22),
      I3 => count_add0000(24),
      O => number_or00001_wg_lut(1)
    );
  number_or00001_wg_cy_1_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(0),
      DI => N0,
      S => number_or00001_wg_lut(1),
      O => number_or00001_wg_cy(1)
    );
  number_or00001_wg_lut_2_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(19),
      I3 => count_add0000(25),
      O => number_or00001_wg_lut(2)
    );
  number_or00001_wg_cy_2_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(1),
      DI => N0,
      S => number_or00001_wg_lut(2),
      O => number_or00001_wg_cy(2)
    );
  number_or00001_wg_lut_3_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(16),
      I3 => count_add0000(26),
      O => number_or00001_wg_lut(3)
    );
  number_or00001_wg_cy_3_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(2),
      DI => N0,
      S => number_or00001_wg_lut(3),
      O => number_or00001_wg_cy(3)
    );
  number_or00001_wg_lut_4_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(13),
      I3 => count_add0000(27),
      O => number_or00001_wg_lut(4)
    );
  number_or00001_wg_cy_4_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(3),
      DI => N0,
      S => number_or00001_wg_lut(4),
      O => number_or00001_wg_cy(4)
    );
  number_or00001_wg_lut_5_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(10),
      I3 => count_add0000(28),
      O => number_or00001_wg_lut(5)
    );
  number_or00001_wg_cy_5_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(4),
      DI => N0,
      S => number_or00001_wg_lut(5),
      O => number_or00001_wg_cy(5)
    );
  number_or00001_wg_lut_6_Q : LUT4
    generic map(
      INIT => X"0008"
    )
    port map (
      ...
      I2 => count_add0000(7),
      I3 => count_add0000(29),
      O => number_or00001_wg_lut(6)
    );
  number_or00001_wg_cy_6_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(5),
      DI => N0,
      S => number_or00001_wg_lut(6),
      O => number_or00001_wg_cy(6)
    );
  number_or00001_wg_lut_7_Q : LUT4
    generic map(
      INIT => X"0002"
    )
    port map (
      ...
      I2 => count_add0000(4),
      I3 => count_add0000(30),
      O => number_or00001_wg_lut(7)
    );
  number_or00001_wg_cy_7_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(6),
      DI => N0,
      S => number_or00001_wg_lut(7),
      O => number_or00001_wg_cy(7)
    );
  number_or00001_wg_lut_8_Q : LUT4
    generic map(
      INIT => X"0001"
    )
    port map (
      ...
      I2 => count_add0000(1),
      I3 => count_add0000(31),
      O => number_or00001_wg_lut(8)
    );
  number_or00001_wg_cy_8_Q : MUXCY
    port map (
      CI => number_or00001_wg_cy(7),
      DI => N0,
      S => number_or00001_wg_lut(8),
      O => number_not0001
    );
  Mcount_number_xor_1_11 : LUT2
    generic map(
      INIT => X"6"
    )
    port map (
  ...
  number_or00001_wg_lut_0_INV_0 : INV
    port map (
      I => count_add0000(23),
      O => number_or00001_wg_lut(0)
    );
  pause_inv1_INV_0 : INV
    port map (
      I => pause_IBUF_264,
      O => pause_inv
    );
